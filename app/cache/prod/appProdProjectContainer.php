...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/assetic/config'), false)));
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony_events', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/jms_serializer'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/xampp/htdocs/symfony_installer/rest/app/logs/prod.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/xampp/htdocs/symfony_installer/rest/app/../web', false);
    }
    protected function getControllerNameConverterService()
    {
        return $this->services['controller_name_converter'] = new \Symfony\Bundle\FrameworkBundle\Controller\ControllerNameParser($this->get('kernel'));
    }
    protected function getFosRest_RequestMatcher_Aa0ef333d0f03745366f0552387560577f3d67f9710d460fce2205710b4d2990481c7ebeService()
    {
        return $this->services['fos_rest.request_matcher.aa0ef333d0f03745366f0552387560577f3d67f9710d460fce2205710b4d2990481c7ebe'] = new \Symfony\Component\HttpFoundation\RequestMatcher(NULL, NULL, NULL);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\xampp\\htdocs\\symfony_installer\\rest\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod',
            ...
            'session.save_path' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/profiler',
            ...
            'router.resource' => 'D:/xampp/htdocs/symfony_installer/rest/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/jms_diextra/doctrine/EntityManager_565715f0d6f2e.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager565715f0d6f2e_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/jms_security',
            ...
            'fos_rest.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/prod/fos_rest',
