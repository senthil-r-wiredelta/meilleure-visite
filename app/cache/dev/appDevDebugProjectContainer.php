...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/assetic/config'), true)));
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager56599a3bd5dc4_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager56599a3bd5dc4_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/jms_diextra/doctrine/EntityManager_56599a3bd5dc4.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_d409bfbda4e8d4fc3bb3728a964f146b');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_d409bfbda4e8d4fc3bb3728a964f146b');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d409bfbda4e8d4fc3bb3728a964f146b');
        ...
        $e->setProxyDir('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager56599a3bd5dc4_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/jms_diextra/metadata'));
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/jms_serializer'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/xampp/htdocs/symfony_installer/rest/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/sessions');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
     ...
     *
     * @return EntityManager56599a3bd5dc4_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev',
            ...
            'debug.container.dump' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/jms_diextra/doctrine/EntityManager_56599a3bd5dc4.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager56599a3bd5dc4_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/jms_security',
            ...
            'fos_rest.cache_dir' => 'D:/xampp/htdocs/symfony_installer/rest/app/cache/dev/fos_rest',
